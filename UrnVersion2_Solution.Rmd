...
This is an example answer for lab task 4 of week 5. Knit it to an html to see
the answers. (I get a Latex error when I knit this to pdf, for reasons I do not see. Also, you will get n error if you just try to :run" this code. It has to be :"knit", for reasons I do not yet understand.)
...
We wil run the model until there are 50 non-black balls in the urn.
