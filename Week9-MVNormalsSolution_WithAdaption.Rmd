...
```{r}
hist(samp.2a$samples[,1],main="Distn of first mean (truth was 3) - run 1",breaks=50)
abline(v=3,lty=2,col="red")
hist(samp.2a$samples[,2],main="Distn of second mean (truth was 1) - run 1",breaks=50)
abline(v=1,lty=2,col="red")

hist(samp.2b$samples[,1],main="Distn of first mean (truth was 3) - run 2",breaks=50)
abline(v=3,lty=2,col="red")
hist(samp.2b$samples[,2],main="Distn of second mean (truth was 1) - run 2",breaks=50)
abline(v=1,lty=2,col="red")
```
